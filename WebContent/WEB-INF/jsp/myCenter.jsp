...
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/css/myCenter.css">
<link rel="stylesheet"
		...
		<div class="boxshadow">
			<div class="top-main">
				...
				<div id="serech_input">
					...
					<a href="${pageContext.request.contextPath }/products/searchitems"
				...
				<div class="show-area col-md-10">
					<div class="Order" data-state="0">
							...
							<div class="Order-search">
								<div class="input-group">
									...
									<div class="input-group-addon">
										<button class="layui-icon layui-icon-search search-button"
						...
						<div class="Order-list">
								...
								<c:forEach items="${allindent}" var="indent" varStatus="status">
									<div class="panel panel-default showli"
										...
										<div class="panel-heading">
											<span class="Order-time">下单时间：${indent.indentTime}</span> <span
												class="Order-id" data-indentID="${indent.indentID }">订单号：${indent.indentID}</span>
											<span class="Order-state"></span> <i
												class="layui-icon layui-icon-delete pull-right"></i>
										</div>
										<div class="panel-body">
											<c:forEach items="${indent.indentDetaillist}"
												...
												<div class="items">
													...
													<div class="price">
														<span>￥</span> <span class="number">${indentDetail.good.goodsPrice}</span>
													</div>
												</div>
											</c:forEach>
										</div>
							...
							<div class="isNoPanel">
								<i class="layui-icon layui-icon-404"></i><span>目前还没有找到符合的订单哦</span>
							</div>
					...
					<div class="Message" data-state="1">
						...
						<div class="Message-list">
							<ul class="nav nav-tabs" role="tablist">
								<li role="presentation" class="active whichChose"><a
									href="#usermsg" aria-controls="home" role="tab"
									data-toggle="tab">账号信息</a></li>
								<li role="presentation"><a href="#resetpwd"
									aria-controls="profile" role="tab" data-toggle="tab">重置密码</a></li>
							</ul>

							<div class="tab-content">
								<div role="tabpanel" class="tab-pane active" id="usermsg">
									<div class="group">
										<label>用户ID:</label> <span class="customerId">${currentCustomer.customerID }</span>
									</div>

									<div class="group">
										<label>用户名:</label> <span class="inputgroup"><input
											type="text" class="customerName" id="customerName"
											value="${currentCustomer.customerName }"> <i
											class="glyphicon glyphicon-ok text-success"></i> <i
											class="glyphicon glyphicon-remove text-danger"></i>
											<p class="text-danger">用户名不符合规范</p> </span>
									</div>
									<div class="group">
										<label>手机号:</label> <span>${currentCustomer.customerPhone }</span>
									</div>
									<div class="group">
										<label>邮箱:</label> <span>${currentCustomer.customerEmail }</span>
									</div>
								...
								<div role="tabpanel" class="tab-pane" id="resetpwd">
									...
									<div class="group">
										<label>旧密码</label> <span class="inputgroup"><input
											type="password" id="oldcustomerPwd" name="oldcustomerPwd">
											<i class="glyphicon glyphicon-ok text-success"></i> <i
											class="glyphicon glyphicon-remove text-danger"></i>
											<p class="text-danger">请输入正确的旧密码</p> </span>
									</div>
									<div class="group">
										<label>新密码</label> <span class="inputgroup"><input
											type="password" id="customerPwd" name="customerPwd">
											<i class="glyphicon glyphicon-ok text-success"></i> <i
											class="glyphicon glyphicon-remove text-danger"></i>
											<p class="text-danger">密码不符合规范</p> </span>
									</div>
									<div class="group">
										<label>确定新密码</label> <span class="inputgroup"><input
											type="password" id="recustomerPwd" name="recustomerPwd">
											<i class="glyphicon glyphicon-ok text-success"></i> <i
											class="glyphicon glyphicon-remove text-danger"></i>
											<p class="text-danger">密码不一致</p> </span>
									</div>
									<input type="hidden" id="OldPassword"
										value="${currentCustomer.customerPwd}"
										data-id="${currentCustomer.customerID}">
									<div class="group">
					...
					<div class="Address" data-state="2">
						<div class="Address-top">
							<h3>地址管理</h3>
							<button
								class="Address-add layui-btn layui-btn-radius layui-btn-primary pull-right"
								data-toggle="modal" data-target="#myModal">添加地址</button>
								...
								<div class="modal-dialog" role="document"
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<div class="group">
												<label>用户地址</label> <span class="inputgroup"><input
											...
											<div class="group">
												<label>邮政编码</label> <span class="inputgroup"><input
													type="text" id="addressPostcode" name="addressPostcode">
													<i class="glyphicon glyphicon-ok text-success"></i> <i
													class="glyphicon glyphicon-remove text-danger"></i>
													<p class="text-danger">输入正确的邮政编码</p> </span>
											</div>
											<div class="group">
												<label>联系电话</label> <span class="inputgroup addrphone"><input
													type="text" id="addressPhone" name="addressPhone">
													<i class="glyphicon glyphicon-ok text-success"></i> <i
													class="glyphicon glyphicon-remove text-danger"></i>
													<p class="text-danger">请输入正确的电话号码</p> </span>
											</div>
											<div class="group">
												<label>收件人</label> <span class="inputgroup"><input
													type="text" id="addressName" name="addressName"> <i
													class="glyphicon glyphicon-ok text-success"></i> <i
													class="glyphicon glyphicon-remove text-danger"></i>
													<p class="text-danger">请输入正确的收件人</p> </span>
											</div>
										</div>
										<div class="modal-footer">
											<button type="button"
												class="layui-btn-primary layui-btn layui-btn-radius Address-addsubmit"
												data-dismiss="modal">保存</button>
											<button type="button"
												class="layui-btn-primary layui-btn layui-btn-radius Address-mod"
							...
							<tbody>
								...
								<c:forEach items="${currentCustomer.addressList}" var="address"
									...
									<tr>
										...
										<td><button
												class="layui-btn layui-btn-radius layui-btn-primary Address-modify"
												data-target="#myModal" data-toggle="modal">修改</button>
											<button
												class="layui-btn layui-btn-radius layui-btn-primary Address-delect">删除</button>
										</td>
									</tr>
								</c:forEach>
							</tbody>
	...
	<div class="Evaluate-area">
		...
		<form id="mainform" method="post" action="#"
			...
			<div class="Evaluate-img">
				<ul class="img-list">
					<li class="Evaluate-img-item"><a><img class="testimg1"
							data-address=""><input type="file" data-which="1"
							name="id1" id="pic1" class="form-img" accept="image/*" /></a></li>
					<li class="Evaluate-img-item"><a><img class="testimg2"
							data-address=""><input type="file" data-which="2"
							name="id2" id="pic2" class="form-img" accept="image/*" /></a></li>
					<li class="Evaluate-img-item"><a><img class="testimg3"
							data-address=""><input type="file" data-which="3"
							name="id3" id="pic3" class="form-img" accept="image/*" /></a></li>
					<li class="Evaluate-img-item"><a><img class="testimg4"
							data-address=""><input type="file" data-which="4"
							name="id4" id="pic4" class="form-img" accept="image/*" /></a></li>
				</ul>
			</div>
			<input type="hidden" value="${currentCustomer.customerID}"
				name="customer.customerID" /> <input type="hidden" id="goodsSpecify"
				name="goodsSpecify" />
			<div class="Evaluate-main">
				<span class="title">评论区</span>
				<textarea placeholder="请输入你的评价" id="evaluateContent"
					name="evaluateContent" style="resize: none"></textarea>
			</div>
			<button type="submit"
				class="layui-btn layui-btn-radius layui-btn-primary addcomment">提交评论</button>
